/**
 * SHAIVIKA LMS AI Platform - AI Knowledge & Quiz Engine Types
...
export interface QuestionItem {
  ...
  correctAnswer: string | string[] | Record<string, string>; // Flexible correct answer
  matchPairs?: MatchPair[]; // For match_following
  commandHint?: string; // For command_based or syntax
  expectedOutput?: string; // For output_prediction
...
export interface StudentProgressDoc {
  ...
  linuxLabProgress: {
    totalLabsAttempted: number;
    totalLabsPassed: number;
    lastLabCompletedAt?: string;
  };
  assignmentStatus: {
