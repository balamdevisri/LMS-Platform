              ...
              learningUnits: (top.learningUnits || []).map((u: any) => {
                ...
                if (subLesson) {
                  return {
                    ...
                    conceptTheory: subLesson.conceptTheory || subLesson.readingContent || subLesson.content || u.conceptTheory || '',
                    content: subLesson.content || subLesson.readingContent || u.content || '',
