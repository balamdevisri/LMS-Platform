...
export const UnitContentEditor: React.FC<UnitContentEditorProps> = ({
  ...
  const handleSave = async (isDraft = false) => {
    ...
    const updatedUnit: LearningUnitItem = {
      ...
      type,
      videoUrl: type === 'Video' ? videoUrl.trim() : (videoUrl.trim() || unit.videoUrl || undefined),
      ...
      quizQuestions: type === 'Quiz' ? quizQuestions : (quizQuestions && quizQuestions.length > 0 ? quizQuestions : undefined),
