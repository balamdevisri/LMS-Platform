      ...
      <div className="bg-white rounded-3xl border border-sky-200 max-w-lg w-full p-6 shadow-2xl space-y-4 font-['Sora'] text-slate-900 animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-sky-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-heading font-extrabold text-base text-slate-900">Edit Student Record</h3>
              <p className="text-[11px] text-slate-500 font-medium">Update academic credentials & permissions</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-medium">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-sky-200 rounded-xl py-2 px-3 focus:outline-hidden font-medium"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block text-slate-700 font-bold mb-1">Institution / College</label>
              <input
                type="text"
                value={college}
          ...
          <div>
            <label className="block text-slate-700 font-bold mb-1">Bio Summary</label>
            <textarea
              rows={2}
              value={bio}
              onChange={(e) => setBio(e.target.value)}
              className="w-full bg-slate-50 border border-sky-200 rounded-xl py-2 px-3 focus:outline-hidden font-medium resize-none"
            />
          </div>
