...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-50/40 dark:bg-zinc-950/20 text-slate-650 dark:text-zinc-400 pt-24 pb-12 border-t border-[#E6EEF9] dark:border-zinc-850 relative overflow-hidden font-['Sora']">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="pt-2">
              <span className="text-[10px] font-bold text-slate-800 dark:text-zinc-300 uppercase tracking-widest block mb-3">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-2 max-w-md">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-zinc-900 border border-[#E6EEF9] dark:border-zinc-800 focus:border-blue-500 focus:outline-hidden rounded-xl py-3 pl-10 pr-3.5 text-xs text-slate-900 dark:text-white transition-colors"
                  />
                </div>
                <button
                  type="submit"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 lg:col-span-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-xs font-semibold">
                <li><a href="#courses" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Courses Catalog</a></li>
                <li><a href="#features" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">AI Core Features</a></li>
                <li><a href="#pricing" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Pricing Plans</a></li>
                <li><Link to="/dashboard" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Interactive IDE</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-xs font-semibold">
                ...
                <li className="flex items-center gap-1.5">
                  ...
                  <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">API Reference</a>
                </li>
                <li className="flex items-center gap-1.5">
                  <Award className="w-3.5 h-3.5 text-blue-500" />
                  <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Certificates</a>
                </li>
                <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Status Logs</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-4 col-span-2 sm:col-span-1">
              ...
              <ul className="space-y-3 text-xs font-semibold">
                <li><a href="#about" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">About Brand</a></li>
                <li className="flex items-center gap-1.5">
                  <Briefcase className="w-3.5 h-3.5 text-blue-500" />
                  <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Careers</a>
                ...
                <li><a href="#about" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Security SOC2</a></li>
                <li><a href="#about" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Privacy Policy</a></li>
              </ul>
            </div>
        ...
        {/* Divider */}
        <div className="h-px bg-[#E6EEF9] dark:bg-zinc-850 w-full" />

        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-slate-500 dark:text-zinc-400 font-['Sora']">
          <div className="space-y-1 text-center md:text-left">
            <p>© {new Date().getFullYear()} Kaizen Q Inc. All rights reserved.</p>
            <p className="text-[10px] text-slate-400 dark:text-zinc-500">Platform credentials verified by ISO 27001 & SOC3 audits.</p>
          </div>
          ...
          <div className="flex items-center space-x-3.5">
            <a
              ...
              className="w-9 h-9 rounded-xl bg-white dark:bg-zinc-900 border border-[#E6EEF9] dark:border-zinc-800 flex items-center justify-center text-slate-650 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-450 hover:scale-105 transition-all shadow-2xs"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-xl bg-white dark:bg-zinc-900 border border-[#E6EEF9] dark:border-zinc-800 flex items-center justify-center text-slate-650 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-455 hover:scale-105 transition-all shadow-2xs"
