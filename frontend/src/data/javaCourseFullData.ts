...
const createLesson = (
  ...
  resources: [
    {
      id: `res-${id}-pdf-notes`,
      name: 'Java Through OOPs.pdf',
      description: 'Java Through OOPs textbook reference PDF.',
      category: 'PDF',
      fileSize: '4.5 MB',
      downloadPermission: true,
      url: '/java through oops complete notes.pdf'
    }
  ]
});

const javaSyllabusNotes: Record<number, string> = {
  1: `
...
export const javaCourseModules: ModuleItem[] = [
  {
    id: 'java-mod-1',
    title: 'Module 1 — Introduction to Java',
    description: 'What is Java, features, JDK vs JRE vs JVM, compilation flow, syntax, and hello world.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-1',
        title: 'Topic 1: Execution Mechanics',
        description: 'Compiling source code to bytecode, class structures, main method modifiers.',
  ...
  },
  {
    ...
    description: 'Primitive and reference variables, type casting (widening and narrowing), final constants, and naming conventions.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-2',
        title: 'Topic 2: Variable Declarations',
        description: 'Integer, decimal, character, and boolean sizes and assignments.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-2-notes',
  ...
  },
  {
    ...
    description: 'Arithmetic, relational, logical, assignment, unary, ternary, bitwise operators, and expressions precedence.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-3',
        title: 'Topic 3: Operator Precedence',
        description: 'Short-circuit evaluations, postfix vs prefix increments, bit shifting.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-3-notes',
            'Module 3 - Complete Notes',
            'Operators Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[3]
          )
  ...
  },
  {
    ...
    description: 'System.out printing methods, printf format specifiers, reading keyboard input with Scanner class.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-4',
        title: 'Topic 4: Streams and Scanner',
        description: 'Buffer console stream readers, type parsing inputs, closing stream scanners.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-4-notes',
            'Module 4 - Complete Notes',
            'Input & Output Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[4]
          )
  ...
  },
  {
    ...
    description: 'Control flow branches: if-else ladders, nested evaluations, switch statements, and fall-through checks.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-5',
        title: 'Topic 5: Selection Statements',
        description: 'Constructing logical branching gates, comparing ranges vs discrete integers.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-5-notes',
            'Module 5 - Complete Notes',
            'Conditional Statements Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[5]
          )
  ...
  },
  {
    ...
    description: 'Count-controlled and condition-controlled loops (for, while, do-while), loop controls, and pattern logic.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-6',
        title: 'Topic 6: Iterative Loops',
        description: 'Applying break and continue statements, loops initialization, check, and update expressions.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-6-notes',
            'Module 6 - Complete Notes',
            'Loops Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[6]
          )
  ...
  },
  {
    ...
    description: 'Single and multi-dimensional array indices, array length properties, search queries, and bubble sorting.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-7',
        title: 'Topic 7: Index Arrays',
        description: 'Memory allocation, size constraints, traversing indices, nesting loops for 2D grids.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-7-notes',
  ...
  },
  {
    ...
    description: 'String pool memory references, string immutability characteristics, character extraction, checks, and StringBuilder.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-8',
        title: 'Topic 8: Text Manipulations',
        description: 'Comparing references vs content, using StringBuilder and StringBuffer blocks.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-8-notes',
  ...
  {
    id: 'java-mod-9',
    title: 'Module 9 — Methods',
    description: 'Designing reusable modular methods, parameters configuration, method overloading, and recursion functions.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-9',
        title: 'Topic 9: Method Scopes',
        description: 'Arguments stacks passing, recursive call structures, base termination states.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-9-notes',
            'Module 9 - Complete Notes',
            'Methods Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[9]
          )
  ...
  },
  {
    ...
    description: 'Exceptions vs severe errors, try-catch-finally architectures, custom exception classes, and throwable trees.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-10',
        title: 'Topic 10: Exception Propagation',
        description: 'Checked vs runtime exceptions, throws method signatures, explicitly raising exceptions with throw.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-10-notes',
            'Module 10 - Complete Notes',
            'Exception Handling Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[10]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-11',
    title: 'Module 11 — Packages & Access Modifiers',
    description: 'Class path packaging, package importing conventions, and scope protection keywords.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-11',
        title: 'Topic 11: Scope Control modifiers',
        description: 'Understanding private, default package access, protected class members, and public APIs.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-11-notes',
            'Module 11 - Complete Notes',
            'Packages & Access Modifiers Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[11]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-12',
    title: 'Module 12 — Classes & Objects',
    description: 'Object instantiations, memory heap allocations, constructor functions, variables, and this reference.',
    duration: '3 Hours',
    topics: [
      {
        id: 'java-topic-12',
        title: 'Topic 12: Object Orientations',
        description: 'Constructor setups, overloaded signature properties, using this pointer.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-12-notes',
            'Module 12 - Complete Notes',
            'Classes & Objects Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[12]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-13',
    title: 'Module 13 — Encapsulation',
    description: 'Restricting direct updates of class variables, public access helpers, and setting up input validators.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-13',
        title: 'Topic 13: Getter and Setter Helpers',
        description: 'Data hiding principles, writing validation rules, encapsulation structures.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-13-notes',
  ...
  {
    id: 'java-mod-14',
    title: 'Module 14 — Inheritance',
    description: 'Extending attributes and methods, single vs hierarchical inheritance, parent variables mapping, and super constructor calls.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-14',
        title: 'Topic 14: Subclassing and super',
        description: 'Forming class relationships, superclass reference updates, overridden parent methods.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-14-notes',
  ...
  {
    id: 'java-mod-15',
    title: 'Module 15 — Polymorphism',
    description: 'Different shapes: compile-time overloading, dynamic runtime overriding, upcasting class instances, and dynamic method dispatch.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-15',
        title: 'Topic 15: Runtime Polymorphism',
        description: 'Overriding annotations, runtime method binding, animal-dog polymorphic triggers.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-15-notes',
  ...
  {
    id: 'java-mod-16',
    title: 'Module 16 — Abstraction',
    description: 'Abstract templates, abstract method rules, concrete subclasses structures, and class instantiation blocks.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-16',
        title: 'Topic 16: Abstract templates',
        description: 'Hiding code implementation details, concrete subclasses overrides, class structure.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-16-notes',
            'Module 16 - Complete Notes',
            'Abstraction Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[16]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-17',
    title: 'Module 17 — Interfaces',
    description: 'Interface contracts, keyword interface, implementing multiple parent interfaces, final variables, and default methods.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-17',
        title: 'Topic 17: Interface contracts',
        description: 'Defining public contracts, implementing sets of interfaces, default and static method rules.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-17-notes',
            'Module 17 - Complete Notes',
            'Interfaces Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[17]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-18',
    title: 'Module 18 — Collections Framework',
    description: 'Standard collections framework structure: dynamic ArrayList, LinkedList, unique HashSet, and HashMap.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-18',
        title: 'Topic 18: Collections collections',
        description: 'Dynamic element lists additions, hash key mapping, duplicate elements exclusions.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-18-notes',
            'Module 18 - Complete Notes',
            'Collections Framework Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[18]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-19',
    title: 'Module 19 — Wrapper Classes & Generics',
    description: 'Primitives wrapper objects (Integer, Character), auto-conversion boxing/unboxing, generic class variables, and wildcards.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-19',
        title: 'Topic 19: Generics parameterizations',
        description: 'Writing generic classes, static type-safety parameters, compile checks.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-19-notes',
            'Module 19 - Complete Notes',
            'Wrapper Classes & Generics Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[19]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-20',
    title: 'Module 20 — File Handling',
    description: 'Disk data reader and writer streams, line buffering, and try-with-resources safe stream locks.',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-20',
        title: 'Topic 20: Persistent File Handling',
        description: 'Character stream readers, buffered writers, try-with-resources automatic closures.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-20-notes',
            'Module 20 - Complete Notes',
            'File Handling Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[20]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-21',
    title: 'Module 21 — Important Java Concepts',
    description: 'Static modifiers, final keywords, super pointer scopes, Object parent methods (toString, equals, hashCode).',
    duration: '2 Hours',
    topics: [
      {
        id: 'java-topic-21',
        title: 'Topic 21: Java Modifiers',
        description: 'Defining constants, static memory shares, overriding root Object class methods.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-21-notes',
            'Module 21 - Complete Notes',
            'Important Java Concepts Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[21]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-22',
    title: 'Module 22 — Java Coding Problems',
    description: 'Practical logical programs: even/odd, factorials, array loops search, bubble sort code blocks, and palindromes.',
    duration: '3 Hours',
    topics: [
      {
        id: 'java-topic-22',
        title: 'Topic 22: Practical Coding Exercises',
        description: 'Writing logic scripts, compiling loop matrices, validating code outputs.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-22-notes',
            'Module 22 - Complete Notes',
            'Java Coding Problems Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[22]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-23',
    title: 'Module 23 — OOP Mini Project',
    description: 'Polymorphic transaction application. Creating Payment interface and UPI/Card implementations.',
    duration: '3 Hours',
    topics: [
      {
        id: 'java-topic-23',
        title: 'Topic 23: Complete OOP Mini Project',
        description: 'Building custom interface contracts, overriding payment actions, verifying polymorphic calls.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-23-notes',
            'Module 23 - Complete Notes',
            'OOP Mini Project Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[23]
          )
        ]
      }
    ]
  ...
  {
    id: 'java-mod-24',
    title: 'Module 24 — Java & OOP Interview Questions',
    description: 'Interview preps. Essential questions on structural differences, static methods limitations, and checked exceptions.',
    duration: '3 Hours',
    topics: [
      {
        id: 'java-topic-24',
        title: 'Topic 24: Core Interview prep',
        description: 'Standard java developer questions, coding interview patterns, structural design QAs.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'java-unit-24-notes',
            'Module 24 - Complete Notes',
            'Java & OOP Interview Questions Complete Notes.',
            '45 mins',
            'Reading',
            javaSyllabusNotes[24]
          )
        ]
      }
    ]
