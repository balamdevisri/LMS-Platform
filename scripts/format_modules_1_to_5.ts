...
// Module 1 Formatted
const mod1 = `# Module 1: Introduction to Version Control, Git & GitHub
...
fs.writeFileSync(path.join(outDir, 'mod_1.md'), mod1, 'utf8');
console.log('Generated formatted mod_1.md');
